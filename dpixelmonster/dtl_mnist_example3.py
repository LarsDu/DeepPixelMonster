"""
Implementation of a Convolutional Neural Network with DeepTaylor decomposition layers
...
import matplotlib
try:
        matplotlib.use("TkAgg") #ubuntu hack
except:
...
from plot_format import Formatter 
...
def main(_):
    ...
    #Block1
    cl1 = dtl.Conv2d(x_image, filter_shape = [3,3,1,nf1],padding = 'VALID',name='conv1')
    r1 = dtl.Relu(cl1)
    bn1 = dtl.BatchNorm(r1,'batch_norm1')
    
    cl2 = dtl.Conv2d(r1, filter_shape = [3,3,nf1,nf1],padding = 'VALID',name='conv2')
    r2 = dtl.Relu(cl2)
    bn2 = dtl.BatchNorm(r2,'batch_norm2')
    ...
    cl3s = dtl.Conv2d(r2,filter_shape=[3,3,nf1,nf1],
                      ...
                      name = 'conv3_strided')
    r3 = dtl.Relu(cl3s)
    bn3 = dtl.BatchNorm(r3,'batch_norm3')
    ...
    r4 = dtl.Relu(cl4)
    bn4 = dtl.BatchNorm(r4,'batch_norm4')
    ...
    r5 = dtl.Relu(cl5)
    bn5 = dtl.BatchNorm(r5,'batch_norm5')
    ...
    r6 = dtl.Relu(cl6s)
    bn6 = dtl.BatchNorm(r6,'batch_norm6')
    ...
    c7 = dtl.Conv2d(r6,filter_shape=[3,3,nf2,nf2],
                      ...
                      name = 'conv7_strided')
    r7 = dtl.Relu(c7)
    bn7 = dtl.BatchNorm(r7,'batch_norm7')
